...
public class OnlineMarket {
    ...
    public static void main(String[] args) {
        ...
        User user = User.login("Irina", "1008Irina");
        System.out.printf("Not exists user: %s\n", user.getLogin());

        user = User.login("Kris", "2397Kr");
    ...
    private static void init() {
        ...
        users.put("Ilya", User.register("Olya", "123Olya"));
        users.put("Alina", User.register("Oleg", "123Oleg"));
        users.put("Amin", User.register("Roman", "123Rom"));
